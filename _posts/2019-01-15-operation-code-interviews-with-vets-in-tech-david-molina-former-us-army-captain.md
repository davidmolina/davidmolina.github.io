...
<figure class="audio-embed">
  ...
  <audio controls preload="metadata" style="width: 100%;">
    <source src="https://www.operationcode.org/podcast/audio/david-molina-interview.mp3" type="audio/mpeg">
...
Check out the Operation Code podcast [here](https://www.operationcode.org/podcast).
