...
Whether you're in the product business, ex. food, beverage, retail, or service business, ex. photography, real estate, appraisal, architecture or construction, same thing applies, but 
this means ensuring your customers, patrons and clients can find you regardless of hardware, software or AI. 
- iOS, this means clients can find you on Maps. This [blog here](https://www.adlift.com/blog/how-to-add-your-business-to-apple-maps/) and [here](https://www.simplymac.com/apps/add-business-to-apple-maps) provide great step-by-step instructions.
- Android, this means clients can find you on Google Maps. This [blog here](https://www.geeksforgeeks.org/websites-apps/how-to-add-my-business-to-google-maps/) and [here](https://www.techjunkie.com/how-to-add-business-to-google-maps/) provide great step-by-step instructions.
- Software options are several, including Facebook, Instagram, Snapchat and [location-based services here](https://seosandwitch.com/best-foursquare-competitors-alternatives/) and [here](https://alternativeto.net/software/foursquare/) such as Swarm by Foursquare, Yelp and TripAdvisor. Key here is you won't know how customers and patrons came to you-- so you must excavate the various trails for them to get to you.
